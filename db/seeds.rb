...
SOFTWARE_PACK = [
  ...
  { name: "Clarifying Questions Writer", step_type: "builder", role: "requirements", requirement: "conditional",
  ...
  { name: "Spec Writer", step_type: "builder", role: "code", requirement: "conditional",
  ...
  { name: "Developer Docs Updater", step_type: "builder", role: "code", requirement: "conditional",
