...
was driven entirely by four performance/consistency findings — **all four are fixed
in the current code, each confirmed while writing this report** (see Resolved
findings below).
